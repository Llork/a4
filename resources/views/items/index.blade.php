        ...
        @else
            @foreach($items as $item)
                <div class='item'>
                    ...
                    <!-- The following line of code is difficult to read, but I had to put it all
                         on one line to eliminate the white space before the colon: -->
                    <p class='incident-date'>{{$item->incident_date}} {{$item->type}}@if(isset($item->dictionary_id)){{': ' . $item->dictionary->unique_nickname }}@endif
                    </p>
