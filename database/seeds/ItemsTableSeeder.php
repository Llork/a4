...
class ItemsTableSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        Item::insert([
               ...
               'dictionary_word2' => null,
               'dictionary_word3' => null,
               'description' => 'On March 2, 2017, I had my yearly medical checkup at Dedham Medical Associates, which is located at 1 Lyons Street, Dedham, Massachusetts.  The next day at work (Harvard Business School), someone posted a video about <b>Jenna Lyons</b>.  Of the thousands of videos in our video repository, this is the only one with ‘Lyons’ in the title.',
        ...
        Item::insert([
                 ...
                 'dictionary_word3' => null,
                 'description' => 'On April 29, 2017, a hawk tried to catch a chipmunk in our yard.  I feed the outdoor wildlife (mostly with sunflower seeds) so at any given time I can usually see a chipmunk outside, but this is the first time I witnessed a hawk swooping down in an attempt to catch one.  I then flipped open the dictionary, landed on <b>‘gormandize’</b>, a word that I don’t recall hearing before.  It means <b>‘to eat ravenously’</b> (which makes me wonder if ‘ravenous’ is related to the word <b>‘raven’</b>).',
        ...
        Item::insert([
                  ...
                  'dictionary_word3' => null,
                  'description' => 'On September 23, 2016, I said ‘bugs, bugs, bugs, bugs’, about 10 times in a row. Then I flipped open the dictionary, landed on ‘manual’, but the word right before this, only a fraction of an inch from my finger, was <b>‘mantra: a word repeated to aid in concentration during meditation’</b>.',
        ...
        Item::insert([
                   ...
                   'dictionary_word2' => null,
                   'dictionary_word3' => null,
                   'description' => 'While Elizabeth was on the phone with her older brother Richard, I flipped open the dictionary.  Landed on <b>‘kinsman: a relative, especially a male one’</b>.',
        ...
        Item::insert([
                    ...
                    'dictionary_word2' => null,
                    'dictionary_word3' => null,
                    'description' => 'Just before digging a hole to bury our pet gerbil ‘Diamond’ who passed away (gerbils only live to be 2 or 3, typically), I flipped open the dictonary, landed on <b>‘palm civet’</b>, which it says is a mammal with a long tail and gray or brown fur.',
