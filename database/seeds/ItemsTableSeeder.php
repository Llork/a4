...
class ItemsTableSeeder extends Seeder
{
    ...
    public function run()
    {
        Item::insert([
             ...
             'dictionary_id' => null,
             'image_url' => 'https://www.dropbox.com/s/yl91glzuqecv9ot/2017-05-01%2021.37.55.jpg?dl=0',
             'more_info_link' => null
        ]);
        ...
        Item::insert([
               ...
               'dictionary_word2' => null,
               'dictionary_word3' => null,
               'description' => 'On March 2, 2017, I had my yearly medical checkup at Dedham Medical Associates, which is located at 1 Lyons Street, Dedham.  The next day at work (Harvard Business School), someone posted a video about Jenna Lyons.  Of the thousands of videos in our video repository, this is the only one with ‘Lyons’ in the title.',
        ...
        Item::insert([
                  ...
                  'dictionary_word3' => null,
                  'description' => 'On September 23, 2016, I said ‘bugs, bugs, bugs, bugs’, about 10 times in a row. Then I flipped open the dictionary, landed on ‘manual’, but the word right before this, only a fraction of an inch from my finger, is ‘mantra: a word repeated to aid in concentration during meditation’',
        ...
        Item::insert([
                    ...
                    'dictionary_word2' => null,
                    'dictionary_word3' => null,
                    'description' => 'Just before digging a hole to bury our pet gerbil ‘Diamond’ who passed away (gerbils only live to be 2 or 3, typically), I flipped open the dictonary, landed on ‘palm civet’, which it says is mammal with long tail and gray or brown fur.',
